...
def fig_ev_st_distribution_dep(ev_info,st_info, fname = None):
    ...
    if fname is not None:
        plt.savefig(fname, dpi=300, bbox_inches='tight', facecolor='w', edgecolor='w')
...
def fig_ev_st_distribution_wt(ev_info,st_info, fname = None):
...
def fig_data_plot_remove_outliers(ev_info,st_info,slope,intercept,up,down,dis_min,dis_max, fname = None):
...
def fig_data_plot_phase(ev_info,st_info,phase_list,color_list,dis_min,dis_max, fname = None):
...
def fig_residual_histogram(fn_syn_init,fn_syn_final,fn_obs,range_l,range_r,Nbar,tag1 = "initial",tag2 = "final", fname = None):
...
# %%
# plot: plot the residual histogram of the initial and final model
def fig_data_difference_histogram(fn_A,fn_B,range_l,range_r,Nbar, fname = None):
